    ...
    <main>
      ...
      <section className="max-w-[1200px] mx-auto px-[15px] py-12 text-center">
        ...
        <p className="text-gray-600 max-w-4xl mx-auto leading-relaxed">
          ...
          <Link href="/creators/list" className="text-[#f57c00] hover:underline">
            creators
          </Link>
          ...
          <Link href="/cards/birthday" className="text-[#f57c00] hover:underline">
            Birthday cards
          </Link>
          ,{' '}
          <Link href="/cards/birthday/child" className="text-[#f57c00] hover:underline">
            Kids Birthday cards
          </Link>
          ,{' '}
          <Link href="/cards/anniversary" className="text-[#f57c00] hover:underline">
            Anniversary cards
          </Link>
          ,{' '}
          <Link href="/personalised-photo-cards" className="text-[#f57c00] hover:underline">
            Personalised cards
          </Link>
          {' '}
          <Link href="/cards/wedding" className="text-[#f57c00] hover:underline">
            Wedding cards
          </Link>
          ,{' '}
          <Link href="/cards/new-baby" className="text-[#f57c00] hover:underline">
            New Baby cards
          </Link>
          {' '}and{' '}
          <Link href="/cards/new-home" className="text-[#f57c00] hover:underline">
            New Home cards
          </Link>
